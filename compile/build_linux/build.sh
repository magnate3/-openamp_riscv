...
make ARCH=riscv CROSS_COMPILE=riscv64-linux-gnu-  virt_riscv64_defconfig
make ARCH=riscv ARCH=riscv CROSS_COMPILE=riscv64-linux-gnu- -j${CPU} Image modules
cp arch/riscv/boot/Image ${OUTPUT}
make ARCH=riscv ARCH=riscv CROSS_COMPILE=riscv64-linux-gnu- modules_install INSTALL_MOD_PATH=${OUTPUT}/modules
